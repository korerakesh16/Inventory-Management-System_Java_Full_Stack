        ...
        <form action="./UpdateProductSrv" method="post">
            ...
            <div class="form-group">
                ...
                <select name="type" class="form-control" required>
                    <option value="Mobiles" <%= "Mobiles".equalsIgnoreCase(product.getProdType()) ? "selected" : "" %>>Mobiles</option>
<option value="Laptops" <%= "Laptops".equalsIgnoreCase(product.getProdType()) ? "selected" : "" %>>Laptops</option>
<option value="Tablets" <%= "Tablets".equalsIgnoreCase(product.getProdType()) ? "selected" : "" %>>Tablets</option>
<option value="Televisions" <%= "Televisions".equalsIgnoreCase(product.getProdType()) ? "selected" : "" %>>Televisions</option>
<option value="Cameras" <%= "Cameras".equalsIgnoreCase(product.getProdType()) ? "selected" : "" %>>Cameras</option>
<option value="Accessories" <%= "Accessories".equalsIgnoreCase(product.getProdType()) ? "selected" : "" %>>Accessories</option>
<option value="Other" <%= "Other".equalsIgnoreCase(product.getProdType()) ? "selected" : "" %>>Other Electronics</option>
