...
<div class="container-fluid text-center" style="margin-top: 45px;">
    ...
    <h6>Efficiently Manage, Track, and Control Your Products</h6>
    <p style="font-style: italic; font-size: 15px; color: #33691e;">"Smart Inventory, Smarter Decisions."</p>
    <p style="font-size: 14px; color: #5d4037;">Streamline stock management, ensure accuracy, and gain real-time insights for better business outcomes.</p>
...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="index.jsp"><span class="glyphicon glyphicon-home"></span>&nbsp;Inventory Management System</a>
        </div>
        <div class="collapse navbar-collapse" id="myNavbar">
            <ul class="nav navbar-nav navbar-right">
                ...
                <li><a href="index.jsp?type=Clothing">Clothing</a></li>
                <li><a href="index.jsp?type=Office Supplies">Office Supplies</a></li>
                <li><a href="index.jsp?type=Home Appliances">Home Appliances</a></li>
                <li><a href="index.jsp?type=Furniture">Furniture</a></li>
                    </ul>
                </li>
            </ul>
        </div>
...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="userHome.jsp"><span class="glyphicon glyphicon-home"></span>&nbsp;Inventory Management System</a>
        </div>
        <div class="collapse navbar-collapse" id="myNavbar">
            <ul class="nav navbar-nav navbar-right">
...
<li><a href="userHome.jsp?type=Clothing">Clothing</a></li>
<li><a href="userHome.jsp?type=Office Supplies">Office Supplies</a></li>
<li><a href="userHome.jsp?type=Home Appliances">Home Appliances</a></li>
<li><a href="userHome.jsp?type=Furniture">Furniture</a></li>
                    </ul>
                </li>
                <% if (notf == 0) { %>
...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="adminViewProduct.jsp"><span class="glyphicon glyphicon-home"></span>&nbsp;Inventory Management System</a>
        </div>
        <div class="collapse navbar-collapse" id="myNavbar">
            <ul class="nav navbar-nav navbar-right">
...
<li><a href="adminViewProduct.jsp?type=Clothing">Clothing</a></li>
<li><a href="adminViewProduct.jsp?type=Office Supplies">Office Supplies</a></li>
<li><a href="adminViewProduct.jsp?type=Home Appliances">Home Appliances</a></li>
<li><a href="adminViewProduct.jsp?type=Furniture">Furniture</a></li>
                    </ul>
                </li>
